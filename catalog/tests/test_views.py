...
class AuthorListViewTest(TestCase):
    ...
    def setUpTestData(cls):
        # Создадим 13 авторов для теста pagination (постраничного отображения)
    ...
    def test_lists_all_authors(self):
        # Получим вторую страницу и подтвердим, что в ней осталось (точно) 3 автора
...
class LoanedBookInstanceByUserListViewTest(TestCase):
    ...
    def test_redirect_if_not_logged_in(self):
        resp = self.client.get(reverse('my_borrowed'))
    ...
    def test_logged_in_uses_correct_template(self):
        ...
        self.assertTemplateUsed(resp, 'catalog/bookinstance_list_borrowed_user')
    ...
    def test_only_borrowed_books_in_list(self):
        ...
        get_ten_books = BookInstance.ojects.all()[:10]
        ...
        self.assertTrue('bookinstance-list' in resp.context)
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_redirect_if_not_logged_in(self):
        ...
        # Вручную проверяем переадресацию (не можем использовать assertRedirect, потому что перенаправление непредсказуемо)
    ...
    def test_logged_in_with_permission_borrowed_book(self):
        ...
        # Проверяем, что это позволяет нам залогиниться - это наша книга, и у нас есть правильные права.
        self.assertEqual(resp.status_code, 200)
    ...
    def test_logged_in_with_permission_another_users_borrowed_book(self):
        ...
        # Проверяем, что это позволяет нам залогиниться. Мы - библиотекарь, поэтому мы можем видеть все пользовательские книги.
        self.assertEqual(resp.status_code, 200)
    ...
    def test_uses_correct_template(self):
        ...
        # Проверяем, что мы используем правильные шаблон
